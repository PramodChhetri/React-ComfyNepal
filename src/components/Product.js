...
const Product = ({ product }) => {
  ...
  return (
    <div>
      <div className='border border-[#e4e4e4] h-[300px] mb-8 relative oevrflow-hidden group transition'>
        <div className='w-full h-full flex justify-center items-center'>
          {/* {image} */}
          <div className='w-[200px] mx-auto flex justify-center items-center'>
            <img alt={title} className='max-h-[160px] group-hover:scale-110 transition duration-300' src={image} />
          </div>
        </div>
        {/* buttons */}
